...
async function getAllData(page, currentBreedLink) {
    ...
    const [
        ...
        enjoyToPlay
            ...
            pUtils.getInverseNote(page, process.env.BARK_SELECTOR),
            ...
            pUtils.getInverseNote(page, process.env.GAIN_WEIGHT_SELECTOR),
            ...
            pUtils.getInverseNote(page, process.env.COST_MAINTENANCE_SELECTOR),
            pUtils.getInverseNote(page, process.env.HAIR_LOSS_SELECTOR),
            pUtils.getInverseNote(page, process.env.DROOL_LEVEL_SELECTOR),
